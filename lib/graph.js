function Graph(){
    ...
    Graph.prototype.generateGrid = function(x,y,z,options, gridSpace){
        //
        x = x*gridSpace;
        y = y*gridSpace;
        z = z*gridSpace;
        ...
        for (var i=0; i<x; i++){
            ...
            for (var j=0; j<y; j++) {
                ...
                for (var k=0; k<z; k++){
                    this.node[i][j][k] = [];
                    this.addNode2(i,j,k,!Math.floor(Math.random()*(1/options.wallPercentage)));
                }
            }
        }
    ...
    Graph.prototype.addNode2 = function(x,y,z,wall){
        if (wall === undefined) wall = false;
